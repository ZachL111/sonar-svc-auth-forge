...
`sonar-svc-auth-forge` is centered on backend services work in Kotlin. The technical target is: Design a Kotlin verification harness for auth systems, covering resource planning, capacity fixtures, and failure-oriented tests.
