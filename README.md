...
sonar-svc-auth-forge is a Kotlin project for backend services. It focuses on this technical goal: Design a Kotlin verification harness for auth systems, covering resource planning, capacity fixtures, and failure-oriented tests.
